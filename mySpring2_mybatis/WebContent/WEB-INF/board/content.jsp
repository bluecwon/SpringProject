...
<div align="center">
	...
	<table align="center" border="1" width="600">
			...
			<tr>
				...
				<input type="button" value="글삭제" onclick="window.location='board_delete.do?num=${content.num}'">
				<input type="button" value="글수정" onclick="window.location='board_update.do?num=${content.num}'">
