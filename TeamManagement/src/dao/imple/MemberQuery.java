...
public class MemberQuery extends MappingSqlQuery<Object> {
	private static String sql = "select member_id, member.name as memberName, team.team_id,"
		+ " team.name as teamName from member, team where member.team_id = "
		+ "team.team_id and member_id = ?";
